...
const LocalCriterionSchema = CollectionSchema(
  ...
  properties: {
    r'applicableRole': PropertySchema(
      id: 0,
      name: r'applicableRole',
      type: IsarType.string,
    ),
...
int _localCriterionEstimateSize(
  ...
  var bytesCount = offsets.last;
  bytesCount += 3 + object.applicableRole.length * 3;
...
void _localCriterionSerialize(
  ...
  writer.writeString(offsets[0], object.applicableRole);
  writer.writeString(offsets[1], object.areaId);
  writer.writeString(offsets[2], object.areaName);
  writer.writeString(offsets[3], object.criterionId);
  writer.writeDouble(offsets[4], object.maxScore);
  writer.writeDouble(offsets[5], object.minScore);
...
LocalCriterion _localCriterionDeserialize(
  ...
  object.applicableRole = reader.readString(offsets[0]);
  object.areaId = reader.readString(offsets[1]);
  object.areaName = reader.readString(offsets[2]);
  object.criterionId = reader.readString(offsets[3]);
  object.id = id;
  object.maxScore = reader.readDouble(offsets[4]);
  object.minScore = reader.readDouble(offsets[5]);
...
extension LocalCriterionQueryFilter
  ...
  QueryBuilder<LocalCriterion, LocalCriterion, QAfterFilterCondition>
      applicableRoleEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'applicableRole',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<LocalCriterion, LocalCriterion, QAfterFilterCondition>
      applicableRoleContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'applicableRole',
        value: value,
  ...
  QueryBuilder<LocalCriterion, LocalCriterion, QAfterFilterCondition>
      applicableRoleMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'applicableRole',
        wildcard: pattern,
...
extension LocalCriterionQuerySortBy
  ...
  QueryBuilder<LocalCriterion, LocalCriterion, QAfterSortBy>
      sortByApplicableRole() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'applicableRole', Sort.asc);
    });
  }

  QueryBuilder<LocalCriterion, LocalCriterion, QAfterSortBy>
      sortByApplicableRoleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'applicableRole', Sort.desc);
    });
  }
...
extension LocalCriterionQueryWhereDistinct
  ...
  QueryBuilder<LocalCriterion, LocalCriterion, QDistinct>
      distinctByApplicableRole({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'applicableRole',
          caseSensitive: caseSensitive);
    });
  }
...
extension LocalCriterionQueryProperty
  ...
  QueryBuilder<LocalCriterion, String, QQueryOperations>
      applicableRoleProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'applicableRole');
    });
  }
